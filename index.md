...
<body class="gradientLight">
    <div class="container">
        ...
        <div class="calculatorMenu">
            <!--Fluxo-->
            <div class="fluxLine calcContent">
                <div class="topContent">
                    <label style="margin-right:5px" for="flux">Fluxo(mL/min):</label>
                    <input type="number" id="flux" name="flux" value="1" max="20" min="0" maxlength="2" style="width:40px;" />
                </div>
            ...
            <div class="mobilePhase calcContent">
                ...
                <div class="mobileBox">
                    ...
                    <label>C<input type="number" id="mobileC" class="mobile" max="100" min="0" value="00" maxlength="3" />%</label>
                    <label>D<input type="number" id="mobileD" class="mobile" max="100" min="0" value="00" maxlength="3" />%</label>
                </div>
            </div>
            <!--RESULTADOS-->
            <div class="bottomBox">
